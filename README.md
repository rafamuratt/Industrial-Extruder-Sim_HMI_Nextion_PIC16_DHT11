...
An industrial-grade HMI simulation of a Reifenh�user-style plastic extruder line. 
...
* Digital Twin Interface: Replicates a Reifenh�user extruder line with animated GIFs synchronized to motor PWM load.
...
* Error Detection: Sensor data is validated via CheckSum. Disconnection or data corruption displays ### and triggers an alarm.
